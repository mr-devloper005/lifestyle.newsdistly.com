...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] bg-white p-8 text-center shadow-[0_18px_40px_rgba(58,39,118,0.08)]', className)}>
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[var(--slot4-page-bg)] text-[var(--slot4-accent-fill)]">
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[var(--slot4-accent-fill)] px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5">
        {actionLabel}
